...
public class State {
	...
	public int approximateDistance() {
		...
		//return (this.misEast + canEast) / 2;
		//return this.misEast + this.canEast - 1;
		//return this.misEast + this.canEast + this.misWest + this.canWest;
		//return this.misWest + this.canWest;
